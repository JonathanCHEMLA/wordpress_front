...
<body <?php body_class(); ?>>
    ...
    <div id="logo-navigation" class="logo-navigation">
        ...
        <header id="site-header" class="site-header" style="background-image: url(http://www.theriversouth.org/wp-content/uploads/2015/12/light-abstract-wallpapers5-1024x576.jpg);">
            <div id="site-branding" class="site-branding">
                <h1 class="site-title"><a href="<?php echo esc_url(home_url('/')); ?>">CHEMLA Jonathan</a></h1>
                <h4 class="site-description">BIENVENUE</h4>
            </div>
        </header>
